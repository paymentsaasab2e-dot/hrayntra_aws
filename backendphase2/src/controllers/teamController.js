...
export async function updateTeamMember(req, res) {
  try {
    ...
    console.log('📝 Update Team Member Request:', { id, body: req.body });
    ...
    console.log('✅ Team member updated successfully:', updatedMember.id);
...
export async function deleteTeamMember(req, res) {
  try {
    ...
    console.log(`✅ Team member deleted successfully: ${member.firstName} ${member.lastName}`);
