...
export const ALERT_CATALOG = [
  ...
  {
    id: 'lead.followup_upcoming',
    module: 'Leads',
    label: 'Follow-up Upcoming',
    description: 'Lead follow-up due within the next 48 hours.',
    emailTriggerId: 'lead.followup_email',
    category: 'LEAD',
    severity: 'warning',
    defaultEmail: true,
  ...
  {
    id: 'client.followup_upcoming',
    module: 'Clients',
    label: 'Client Follow-up Upcoming',
    description: 'Client follow-up due within the next 48 hours.',
    emailTriggerId: 'client.followup_email',
    category: 'CLIENT',
    severity: 'warning',
    defaultEmail: true,
