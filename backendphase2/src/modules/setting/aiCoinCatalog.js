...
export const PHASE2_AI_FEATURE_CATALOG = [
  ...
  {
    id: 'ai.lead_details',
    name: 'Lead AI autofill',
    description: 'Autofill lead company and contact details',
    coins: 3,
    category: 'CRM',
  },
  {
    id: 'ai.lead_chat',
    name: 'Lead AI chat',
    description: 'Chat with AI to refine lead details',
    coins: 2,
    category: 'CRM',
  },
  {
    ...
    description: 'Autofill client company and contact details',
    coins: 3,
    category: 'CRM',
  },
  {
    id: 'ai.client_chat',
    name: 'Client AI chat',
    description: 'Chat with AI to refine client details',
    coins: 2,
    category: 'CRM',
  },
  {
