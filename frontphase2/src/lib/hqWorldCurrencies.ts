...
export const WORLD_CURRENCIES: WorldCurrencyEntry[] = [
  ...
  { code: 'XCD', name: 'East Caribbean Dollar', countries: 'Antigua and Barbuda, Dominica, Grenada, Saint Kitts and Nevis, Saint Lucia, Saint Vincent and the Grenadines' },
  ...
  { code: 'SHP', name: 'Saint Helena Pound', countries: 'Saint Helena' },
