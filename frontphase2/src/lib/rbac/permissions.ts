...
export const PERMISSION_DISPLAY_LABELS: Record<string, string> = {
  ...
  hq_employers_dashboard_read: 'Employers — Dashboard',
  hq_companies_read: 'Employers — Companies',
  hq_companies_write: 'Employers — Companies (manage)',
  hq_companies_delete: 'Employers — Companies (delete)',
  hq_tickets_read: 'Employers — Tickets',
  hq_tickets_write: 'Employers — Tickets (update)',
  hq_tickets_delete: 'Employers — Tickets (delete)',
  hq_tenants_read: 'Employers — Users',
  hq_tenants_write: 'Employers — Users (manage)',
  hq_tenants_delete: 'Employers — Recycle Bin',
  hq_billing_read: 'Employers — Subscriptions',
  hq_billing_write: 'Employers — Subscriptions (manage)',
  hq_packages_read: 'Employers — Packages',
  hq_packages_write: 'Employers — Packages (manage)',
  hq_ai_features_read: 'Employers — AI Features',
  hq_ai_features_write: 'Employers — AI Features (manage)',
...
export const MODULE_DISPLAY_LABELS: Record<string, string> = {
  ...
  'Employers · Tenants': 'Employers — Users',
  'Employers · Plans': 'Employers — Subscriptions',
};
