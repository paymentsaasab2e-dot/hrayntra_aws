...
const SAMPLE_VALUES: Record<string, string> = {
  ...
  loginUrl: 'https://app.saasa.ai/login',
  otp: '847291',
  loginId: 'alex.recruiter',
  tempPassword: 'TempPass-42',
  roleName: 'Recruiter',
  loginLink: 'https://app.saasa.ai/login?token=sample',
  resetPasswordLink: 'https://app.saasa.ai/reset-password',
  ...
  portalUrl: 'https://app.saasa.ai/client-review',
