...
export const AddDepartmentDrawer: React.FC<AddDepartmentDrawerProps> = ({ isOpen, onClose, onSuccess, department = null }) => {
  ...
  return (
    <AnimatePresence>
      {isOpen ? (
        <DetailsModalShell
          key="add-department-drawer"
          variant="main"
          dialogTitleId="add-department-modal-title"
          ...
          <form onSubmit={handleSubmit} className="flex h-full min-h-0 flex-col">
            <div className={DRAWER_FORM_HEADER_CLASS}>
              <div className="flex min-w-0 flex-1 items-center gap-3">
                ...
                <div>
                  <h2 id="add-department-modal-title" className="text-lg font-bold tracking-tight text-slate-900">
