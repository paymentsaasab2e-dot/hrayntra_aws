...
export function HqPackagesPanel({
  ...
  const [subTab, setSubTab] = useState<'subscription' | 'ai'>('subscription');
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[720px] text-left text-sm">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50/80 text-[11px] uppercase tracking-wider text-slate-400">
                <th className="px-5 py-3 font-semibold">Plan</th>
                <th className="px-3 py-3 font-semibold">Price</th>
                <th className="px-3 py-3 font-semibold">Limits</th>
                <th className="px-3 py-3 font-semibold text-right">Tenants</th>
