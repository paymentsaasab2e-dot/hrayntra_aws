...
function PieBlock({
  ...
  return (
    <div
      className={`${recCard} group relative overflow-hidden p-5 transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(15,23,42,0.08)]`}
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-amber-500/80 via-orange-400/60 to-emerald-400/50 opacity-80" />
        ...
        <div className="relative h-[148px] w-[148px] shrink-0">
          ...
          {center ? (
            <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
              ...
              <p className="text-lg font-bold text-slate-900">{center}</p>
            </div>
          ) : null}
        </div>
