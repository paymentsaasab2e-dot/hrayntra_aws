...
const { getResume, saveResume, syncCareerPath, improveSection, checkAts, generateSummary, tailorSummary, analyzeResume, getResumeVersions, getResumeVersion } = require('../controllers/resume.controller');
