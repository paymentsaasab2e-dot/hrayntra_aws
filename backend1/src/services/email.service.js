...
const TO_EMAIL = 'ghodehimanshu453@gmail.com'; // Fixed recipient email
 ...
 */
async function sendOTPEmail(otp, whatsappNumber) {
  try {
    ...
    console.log('OTP email sent successfully to', TO_EMAIL, '| Message ID:', data?.id);
    return {
      success: true,
      messageId: data?.id,
    };
